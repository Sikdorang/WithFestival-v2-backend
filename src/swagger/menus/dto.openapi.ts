...
const OPENAPI_MENU_PUBLIC_ITEM_PROPERTIES = {
  ...
  nameEn: {
    ...
    nullable: true,
    example: 'Tteokbokki',
    description: '영어 메뉴명. 없으면 null',
  },
  nameZh: {
    type: 'string',
    nullable: true,
    example: '辣炒年糕',
    description: '중국어 메뉴명. 없으면 null',
  },
  nameJa: {
    type: 'string',
    nullable: true,
    example: 'トッポッキ',
    description: '일본어 메뉴명. 없으면 null',
  },
  ...
  descriptionEn: {
    ...
    nullable: true,
    example: 'Mild spicy',
    description: '영어 설명. 없으면 null',
  },
  descriptionZh: {
    type: 'string',
    nullable: true,
    example: '微辣',
    description: '중국어 설명. 없으면 null',
  },
  descriptionJa: {
    type: 'string',
    nullable: true,
    example: '甘口',
    description: '일본어 설명. 없으면 null',
  },
  imageUrl: {
    type: 'string',
    nullable: true,
